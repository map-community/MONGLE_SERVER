...
public enum AwsErrorCode implements ErrorCode {
    ...
    S3_FILE_TAGGING_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "S3-002", "S3 파일 태깅에 실패했습니다."),
    ...
    SQS_PUBLISH_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "SQS-001", "SQS 이벤트 발행에 실패하였습니다");
